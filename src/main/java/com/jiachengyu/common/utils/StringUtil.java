...
public class StringUtil {
	...
	public static String randomChineseString(int length) {
		...
		for (int i = 0; i < length; i++) {
			str1 +=(char) (random.nextInt(40869 - 19968 + 1) + 19968) + "";
		}
	...
	public static String generateChineseName() {
		String[] somename = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
				...
				"管", "卢", "莫", "经", "房", "裘", "缪", "干", "解", "应", "宗", "丁", "宣", "贲", "邓", "郁", "单", "杭" + "", "洪", "包",
				...
				"祖", "武", "符", "刘", "景", "詹", "" + "束", "龙", "叶", "幸", "司", "韶", "郜", "黎", "蓟", "薄", "印", "宿", "白", "怀",
				...
				Random random=new Random();
				int nextInt = random.nextInt(somename.length-1);
				String strname = somename[nextInt];
				if(random.nextBoolean()) {
					strname+=StringUtil.randomChineseString(2);
				}else {
					strname+=StringUtil.randomChineseString(1);
				}
				return strname;
	}
}
